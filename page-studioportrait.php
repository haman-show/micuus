...
<section class="servicemenu studio">
  <div class="asumi-container">
    ...
    <h2 class="ff-min">可能性を可視化して未来を先撮りしよう</h2>
  </div>
</section>
<section class="news">
  <div class="asumi-container">
...
<section class="concept">
  ...
  <div class="holder">
    <h1 class="ff-min">自分のポテンシャルは自分で決めちゃいけない！</h1>
    <h2>The only one photography</h2>
    <ul>
      <li>一人一人の可能性は、目に見えない性質的なものもあれば、<br>
生まれてから備わっている顔立ち、選ぶ服装、仕草まで、様々です。</li>
      <li>「もっとこうなりたい」</li>
      <li>それは、誰もが持っている願望ですが<br>
      大体は、自分は〇〇だから、〇〇だろう。と<br>
      自分のポテンシャルを自分で決めてしまう事がとても多いのも事実です。</li>
      <li>だけど、それって本当に本当？</li>
      <li>遠藤あすみフォトセッションでは、<br>
      ヘアメイクからライティング、撮影まで全て一人一人に合わせた<br>
      オーダーメイドの撮影を行なっていきます。</li>
      <li>素材の声を聞き、可能性を切り開く事が私の特技です。<br>
      自分で「大好き！」と心から思える写真を手にして、可能性の扉を開きましょう！</li>
    </ul>
  </div>
...
<section class="detail">
  <h1 class="ff-min">遠藤アスミフォトセッション</h1>
  <div class="fee">撮影料金<span>税込4万円</span></div>
  <ul class="service">
    <li>ヘアセット＆メイク込み</li>
    <li>衣装２着まで<br>
    （お持ち込みお願い致します！悩んでしまったら多めに持ってきて一緒に選ぶ事も可能です。<br>
    アクセサリー類も忘れずにお持ち込み下さい。）</li>
    <li>所要時間2.5h</li>
    <li>商用可能</li>
    <li>撮影全データーをCDRに焼いて当日にお渡しします。（macの方はUSBをご持参ください）</li>
  </ul>
  <ul class="caution">
    <li>※当日現金でのご清算をお願い申し上げます。</li> 
    <li>※キャンセルご変更は２日前まで可能です<br>
   （それ以降はいかなる場合も全額ご負担となってしまいますので、予めご了承下さい。）</li>
  </ul>
  <ul class="read">
    <li>お写真は、<br>
    普段私がFBにアップしているような、<br>
    バストアップから全身まで オーダーメイドのメイク&ライティングで撮影させて頂きます。<br>
    １着目、２着目と雰囲気を変えてお撮りしていきますので、<br>
    是非、雰囲気の異なるお洋服をお持ちになっていらして下さい。</li>
    <li>小物類のお持ち込みも可能ですので、PC等のお仕事アイテム等、ご自由にご持参ください。<br>
    髪の毛アップを希望する方は、ヘアアクセサリー等もお忘れずに！</li>
    <li>撮影は300枚程撮影致しまして、<br>
    その中から6枚ほど 私が目のあったお写真にレタッチをお入れして<br>
    撮影データー＆レタッチデーターをお渡ししております。<br>
...
<section class="waiting">
  ...
  <a href="" target="_blank" class="button">キャンセル待ち登録</a>
</section>
</div>
